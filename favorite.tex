...
% 문제 계열
% 본문 중간
ck - check - 가벼운 예제 (출력 예시: check 18.1.1)
ck* - check* 
pr - practice - 단원 요약, 심화, 실생활 문제 (출력 예시: practice 18.4.2)
pr* - practice*
% 본문 이후
...
\addtocounter{figure}{1}% 나중에 지우기. 그림번호 카운트하기 위함
\addtocounter{equation}{1}% 나중에 지우기. 식번호 카운트하기 위함

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%%%%%%%%  subsubection  %%%%%%%%%%%%%%%%
\subsubsection{The External Electric Field}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% solbox - 본문에선 1,2를 쓰고, question, problem에서는 3을 사용
