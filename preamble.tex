...
\input{../../latex_structure/package.sty} % 컴파일이 일어나는 main 기준으로 두 단계 올라가서 다시 내려옴
\input{../../latex_structure/page.sty}
\input{../../latex_structure/format.sty}
\input{../../latex_structure/box.sty}
\input{../../latex_structure/tablefigure.sty}
\input{../../latex_structure/seolf.sty}
